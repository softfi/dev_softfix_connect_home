  ...
  return (
    <>
      ...
      <section className="relative flex justify-center items-center">
        {/* <div className="w-[80vw] h-[45vw]">
          <img className="rounded-3xl" src={laptopMockUp} alt="People" />
          <button className="font-bold flex justify-center items-center gap-4 absolute bg-white text-black px-12 py-4 rounded-full shadow-xl top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hover:scale-105 transition-all">
            <p>Why Connectteam?</p>
            <FaPlay />
          </button>
        </div> */}
      ...
      {/* Two image section  */}
      <section className="relative flex justify-center items-center bg-gradient-to-r from-gray-100 to-gray-200">
        <div className="relative grid grid-cols-1 w-[80vw] h-[45vw]">
          {/* <div className="bg-gray-400 rounded-l-[2rem] flex justify-center items-center">
            <img src={office} alt="People" />
          </div> */}
          <div className="  rounded-[2rem] flex justify-center items-center">
            <img src={laptopMockUp} alt="Group" className="ms-[4rem]" />
          </div>
          {/* <button className="font-bold flex justify-center items-center gap-4 absolute bg-white text-black px-12 py-4 rounded-full shadow-xl top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hover:scale-105 transition-all">
            <p>Why Connectteam?</p>
            <FaPlay />
